...
public class UserReportController {
    ...
    @PostMapping
    @PreAuthorize("hasAuthority('POST:/api/user-reports')")
    ...
    @PreAuthorize("hasAuthority('GET:/api/user-reports/user/{userId}')")
    ...
    @GetMapping
    @PreAuthorize("hasAuthority('GET:/api/user-reports')")
